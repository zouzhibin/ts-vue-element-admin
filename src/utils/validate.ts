 ...
 * @returns {boolean}
 */
export function isPort(str:any) {
 ...
 * @returns {boolean}
 */
export function isIdCard(str:any) {
 ...
 * @returns {boolean}
 */
export function isChina(str:any) {
  const reg = /^[\u4E00-\u9FA5]{2,4}$/;
  return reg.test(str);
}
 ...
 * @returns {boolean}
 */
export function isLongitude(str:any) {
 ...
 * @returns {boolean}
 */
export function isLatitude(str:any) {
 ...
 * @returns {boolean}
 */
export function isRTSP(str:any) {
